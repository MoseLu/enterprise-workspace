...
var moduleName = "\u7BA1\u7406\u6A21\u5757";
function loadAppsConfig(root) {
  try {
    const configPath = resolve11(root, "../../apps.config.json");
...
// vite.config.ts
var __vite_injected_original_import_meta_url6 = "file:///C:/Users/mlu/Desktop/btc-shopflow/btc-shopflow-monorepo/apps/admin-app/vite.config.ts";
