  ...
  'zh-CN': {
    ...
    common: {
      ...
      system: {
        ...
        btc_shop_management_system_engineering: 'BTC车间管理系统 - 工程应用',
        engineering_module: '工程模块',
        bellis: '拜里斯',
        address: '深圳市南山区科技园',
  ...
  'en-US': {
    ...
    common: {
      ...
      system: {
        ...
        btc_shop_management_system_engineering: 'BTC Shop Management System - Engineering App',
        engineering_module: 'Engineering Module',
        bellis: 'Bellis',
