...
- **BtcContainer** - 容器组件，提供统一的布局容器
  - 📄 [文档](../../../packages/shared-components/src/common/container/README.md)
...
- **BtcSearch** - 搜索组件，用于快速搜索功能
  - 📄 [文档](../../../packages/shared-components/src/common/search/README.md)

#### 布局组件
- **BtcViewGroup** - 视图组合组件，支持多种视图模式
- **BtcGridGroup** - 网格组组件，用于网格布局
  - 📄 [文档](../../../packages/shared-components/src/common/grid-group/README.md)
...
- **BtcMasterList** - 通用主列表组件，用于处理主从关系场景（如部门-用户、角色-权限等）
  - 📄 [文档](../../../packages/shared-components/src/components/btc-master-list/README.md)
- **BtcCard** - 卡片组件
- **BtcTabs** - 标签页组件
...
- **BtcMessage** - 消息提示组件（全局 API）
  - 📄 [文档](../../../packages/shared-components/src/components/btc-message/README.md)
- **BtcNotification** - 通知组件（全局 API）
  - 📄 [文档](../../../packages/shared-components/src/components/btc-notification/README.md)
...
- **BtcTable** - 数据表格组件，支持排序、筛选、分页等功能
  - 📄 [文档](../../../packages/shared-components/src/crud/table/README.md)
...
- [BtcTable 文档](../../../packages/shared-components/src/crud/table/README.md) - 数据表格组件
- [BtcMasterList 文档](../../../packages/shared-components/src/components/btc-master-list/README.md) - 主列表组件
- [BtcContainer 文档](../../../packages/shared-components/src/common/container/README.md) - 容器组件
...
- [BtcNotification 文档](../../../packages/shared-components/src/components/btc-notification/README.md) - 通知组件
