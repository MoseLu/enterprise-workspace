...
This document records all version update information for the BTC Shopflow project. Version numbers follow [Semantic Versioning](https://semver.org/lang/zh-CN/).
...
::: tip Auto Sync
This document content is automatically synced from the `CHANGELOG.md` in the project root directory. It is automatically updated each time the documentation sync script is run (`pnpm sync` or during build).
:::
