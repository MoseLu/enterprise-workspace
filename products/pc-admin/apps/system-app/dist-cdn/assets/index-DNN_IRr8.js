        ...
        submit: async (data, { close, done }) => {
          try {
            ...
            const { useUser } = await __vitePreload(async () => {
              const { useUser: useUser2 } = await import("https://all.bellis.com.cn/system-app/assets/useUser-BuZZyFiO.js");
    ...
    const handleAvatarChange = async (avatarUrl) => {
      try {
        const { service: service2 } = await __vitePreload(async () => {
          const { service: service3 } = await import("https://all.bellis.com.cn/system-app/assets/eps-service-CyhGCtaT.js").then(function(n) {
            return n.a;
          });
