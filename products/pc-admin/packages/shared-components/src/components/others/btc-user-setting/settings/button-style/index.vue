<template>
  <div class="button-style-settings">
    <SectionTitle :title="t('theme.buttonStyles.title') || 'Button Style'" :style="{ marginTop: '40px' }" />
          ...
          <div class="btn-preview__inner">
            <template v-if="item.value === 'default'">
              <span class="btn-preview primary with-text">
                ...
                <span class="btn-text">{{ t('theme.buttonStyles.primary') }}</span>
              </span>
              <span class="btn-preview secondary with-text">
                <span class="btn-text">{{ t('theme.buttonStyles.secondary') }}</span>
              </span>
            </template>
            <template v-else>
...
const buttonStyleOptions = computed(() => [
  {
    ...
    label: t('theme.buttonStyles.default'),
  },
  {
    value: 'minimal' as ButtonStyle,
    label: t('theme.buttonStyles.minimal'),
  },
]);
