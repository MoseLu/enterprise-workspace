...
/**
 * 绫诲瀷瀹夊叏鐨勭炕璇戝嚱鏁? */
export type TypeSafeT = <K extends keyof I18nKeyPath>(key: K, params?: Record<string, any>) => string;
/**
 * 鍒涘缓绫诲瀷瀹夊叏鐨?useI18n hook
 */
export declare function createTypeSafeI18n(t: any): TypeSafeT;
/**
 * 楠岃瘉缈昏瘧閿槸鍚﹀瓨鍦? */
export declare function validateI18nKey(key: string): key is keyof I18nKeyPath;
/**
 * 鑾峰彇鎵€鏈夊彲鐢ㄧ殑缈昏瘧閿? */
export declare function getAllI18nKeys(): (keyof I18nKeyPath)[];
/**
 * 鍥介檯鍖栧璁″伐鍏? */
export declare class I18nAuditor {
    private usedKeys;
    private definedKeys;
    /**
     * 璁板綍浣跨敤鐨勯敭
     */
    recordUsedKey(key: string): void;
    /**
     * 璁板綍瀹氫箟鐨勯敭
     */
    recordDefinedKey(key: string): void;
    /**
     * 鑾峰彇鏈娇鐢ㄧ殑閿?   */
