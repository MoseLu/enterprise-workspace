import { s as storage, a as syncSettingsToCookie, p as processURL, r as responseInterceptor, B as BtcMessage } from "./vendor-tN3qNEcA.js";
    ...
    const onFulfilled = (response) => {
      ...
      if (isLoginResponse) {
        ...
        if (isLoginSuccess) {
          ...
          try {
            __vitePreload(async () => {
              const { startUserCheckPolling } = await import("https://all.bellis.com.cn/system-app/assets/vendor-tN3qNEcA.js").then(function(n) {
                return n.dy;
              });
